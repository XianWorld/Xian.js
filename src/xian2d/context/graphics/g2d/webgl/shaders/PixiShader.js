...
PixiShader.prototype.init = function()
{
    ...
    var program = Utils.compileProgram(gl, this.vertexSrc || PixiShader.defaultVertexSrc, this.fragmentSrc);
...
PixiShader.prototype.initSampler2D = function(uniform)
{
    ...
    if (uniform.textureData)
    {
        ...
        else
        {
            ...
            gl.texImage2D(gl.TEXTURE_2D, 0, format, gl.RGBA, gl.UNSIGNED_BYTE, uniform.value.raw);
        }
