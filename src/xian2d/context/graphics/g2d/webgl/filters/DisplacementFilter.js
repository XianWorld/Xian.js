...
DisplacementFilter.prototype.onTextureLoaded = function () {
    ...
    this.uniforms.displacementMap.value.off('inited', this.boundLoadedFunction);
};
...
Object.defineProperty(DisplacementFilter.prototype, 'map', {
    ...
    set: function (value) {
        ...
        if(this.uniforms.displacementMap.value) this.uniforms.displacementMap.value.release();
...
DisplacementFilter.prototype.destroy = function() {
    if(this.map)
        this.map.release();
