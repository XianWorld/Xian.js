...
//var RenderContext = require("../graphics/graphics_context");
var FilterTexture = require("../graphics/filter_texture");
var CanvasBuffer = require("../graphics/canvas_buffer");
...
RenderTexture.prototype.getBuffer = function (gl) {
...
RenderTexture.prototype.getCanvas = function (gl) {
    //if (this.renderer.type === WEBGL_RENDERER)
    if (gl) {
        //var gl = this.renderer.gl;
