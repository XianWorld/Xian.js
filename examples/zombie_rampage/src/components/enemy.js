...
var shotgunAmmo = require("../shotgun_ammo");
var uziAmmo = require("../uzi_ammo");
var flamethrowerAmmo = require("../flamethrower_ammo");
var rocketAmmo = require("../rocket_ammo");
...
var Time = Xian.Time,
    ...
    moans = [
        Xian.Assets.get("snd_zombie_moan1"),
        Xian.Assets.get("snd_zombie_moan2"),
        Xian.Assets.get("snd_zombie_moan3"),
        Xian.Assets.get("snd_zombie_moan4")
    ];
